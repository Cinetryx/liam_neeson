...
import moveit_commander #only really serves to add level of robustness
...
def initialize():
    ...
    pos = [0,0,0,0,0,0,0]
    gl.moveToJointPosition(jts_left, pos)
...
if __name__=='__main__':
    try:
        rospy.init_node('PointAndPointSomeMore', anonymous=True)
        initialize()
